...
"[project]/apps/web/app/api/sessions/public/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const now = new Date();
        const sessions = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].trainingSession.findMany({
            where: {
        ...
        const sessionsWithAvailability = sessions.map((session)=>({
                ...session,
                availableSpots: session.maxLearners ? Math.max(0, session.maxLearners - session.registeredCount) : null,
                isFull: session.maxLearners ? session.registeredCount >= session.maxLearners : false
            }));
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$4_react$2d$dom$40$19$2e$2$2e$3_react$40$19$2e$2$2e$3_$5f$react$40$19$2e$2$2e$3$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(sessionsWithAvailability);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__42b6685b._.js.map
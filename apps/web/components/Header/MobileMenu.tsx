        ...
        <div className="space-y-2">
          ...
          <div>
            <button
              ...
              className={`flex items-center cursor-pointer justify-between w-full px-3 py-2 rounded-full font-satoshi font-medium transition-all duration-300 ${
                isFormationsActive
                  ? "bg-primary text-white"
                  : "text-blackBlue hover:text-primary"
              }`}
            >
          ...
          <Link
            ...
            onClick={onClose}
            className={`block px-3 py-2 rounded-full font-satoshi font-medium transition-all duration-300 ${
              isValeursActive
                ? "bg-primary text-white"
                : "text-blackBlue hover:text-primary"
            }`}

...
function FooterLogo() {
  return (
    <Link
      href="/"
      className="flex items-center group transition-all duration-300 mb-4"
    >
      <div className="flex items-center">
        <span className="font-sora font-bold text-3xl text-white tracking-tight">
          Form
        </span>
        <span className="inline-flex items-center justify-center bg-white text-primary font-sora font-bold text-xl px-2.5 py-1 rounded-lg ml-1 transition-transform duration-300 group-hover:scale-105">
          Me
        </span>
      </div>
    </Link>

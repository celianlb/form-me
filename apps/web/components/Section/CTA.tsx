...
export default function CTA() {
  return (
    <section className="bg-gray-100 border border-gray-200 p-6 md:p-12 flex flex-col gap-16 md:gap-20 mx-[40px] md:mx-[120px] rounded-[32px] md:rounded-[50px] my-[80px]">

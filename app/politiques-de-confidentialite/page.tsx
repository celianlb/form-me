          ...
          <div className="space-y-8 font-satoshi text-grayBlue">
            <section>
              ...
              <p className="leading-relaxed">
                Form.Me s&apos;engage à protéger votre vie privée. Cette politique de 
            ...
            <section>
              ...
              <h3 className="text-lg font-medium text-primary mb-2 mt-6">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 leading-relaxed">
                ...
                <li>Vous envoyer des informations relatives à nos formations</li>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 leading-relaxed mt-4">
                ...
                <li><strong>L&apos;exécution du contrat :</strong> pour l&apos;accès aux formations</li>
            ...
            <section>
              ...
              <p className="leading-relaxed">
                Nous ne vendons, ni ne louons, ni ne partageons vos données personnelles 
                avec des tiers, sauf dans les cas suivants :
              </p>
              <ul className="list-disc pl-6 space-y-2 leading-relaxed mt-4">
                <li>Avec votre consentement explicite</li>
                <li>Pour se conformer à une obligation légale</li>
                <li>Avec nos prestataires de services (hébergement, outils d&apos;analyse) 
                    qui s&apos;engagent à protéger vos données</li>
                <li>En cas de fusion, acquisition ou cession d&apos;actifs de notre entreprise</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 leading-relaxed mt-4">
                <li><strong>Données de compte :</strong> pendant toute la durée d&apos;utilisation 
                    de nos services, puis 3 ans après la dernière connexion</li>
                <li><strong>Données de formation :</strong> 5 ans pour répondre aux 
                    obligations réglementaires</li>
            ...
            <section>
              ...
              <p className="leading-relaxed mt-4">
                Ces mesures incluent le chiffrement des données, l&apos;authentification 
                sécurisée, la surveillance des accès et la formation de notre personnel.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="leading-relaxed mt-4">
                ...
                <a href="mailto:form.me@gmail.com" className="text-primary hover:underline ml-1">
                  form.me@gmail.com
                </a>
              </p>
            </section>
            ...
            <section>
              ...
              <p className="leading-relaxed">
                Nos données sont hébergées chez Vercel (États-Unis). Ce prestataire 
                offre des garanties appropriées pour la protection de vos données 
            ...
            <section>
              ...
              <p className="leading-relaxed">
                ...
                Nous vous informerons de tout changement significatif par e-mail ou 
                via une notification sur notre site web.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-none space-y-2 leading-relaxed mt-4">
                <li><strong>Email :</strong> form.me@gmail.com</li>
                <li><strong>Téléphone :</strong> +33 7 66 76 39 11</li>
                <li><strong>Adresse :</strong> Claye Souilly</li>
              </ul>
              <p className="leading-relaxed mt-4">
                Si vous n&apos;êtes pas satisfait de notre réponse, vous avez le droit 
                de déposer une réclamation auprès de la CNIL (Commission Nationale de 
